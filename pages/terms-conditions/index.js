    ...
    <>
      ...
      <div className="px-20 leading-10 font-light">
        <div className="my-16">
          ...
          <p className="my-3 font-medium">OVERVIEW</p>
          <p>
            This website is operated by kadiyamnursery.co. Throughout the site, the terms
            “we”, “us” and “our” refer to kadiyamnursery.co. kadiyamnursery.co offers this
          ...
          <p className="my-3 font-medium">SECTION 1 - ONLINE STORE TERMS</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 2 - GENERAL CONDITIONS</p>
          <p>
          ...
          <p>
            ...
            our Refund Policy, We have made every effort to display as
          ...
          <p className="my-3 font-medium">SECTION 7 - OPTIONAL TOOLS</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 8 - THIRD-PARTY LINKS</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 10 - PERSONAL INFORMATION</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 12 - PROHIBITED USES</p>
          <p>
          ...
          <p>
            ...
            kadiyamnursery.co, our directors, officers, employees, affiliates, agents,
          ...
          <p className="my-3 font-medium">SECTION 14 - INDEMNIFICATION</p>
          <p>
            You agree to indemnify, defend and hold harmless kadiyamnursery.co and our
          ...
          <p className="my-3 font-medium">SECTION 15 - SEVERABILITY</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 16 - TERMINATION</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 17 - ENTIRE AGREEMENT</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 18 - GOVERNING LAW</p>
          <p>
          ...
          <p className="my-3 font-medium">SECTION 20 - CONTACT INFORMATION</p>
          <p>
            Questions about the Terms of Service should be sent to us at
            Address: 44, Pologround Industrial Area, Indore 452001 Call:
            +918035234118
          </p>
        </div>
      </div>
